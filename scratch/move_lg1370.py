...
def move_model_after(sheet_name, target_model, after_model):
    ws = wb[sheet_name]
    ...
    for row in range(2, ws.max_row + 1):
        ...
        if model_name == target_model:
            ...
            continue
        if model_name: # Keep only non-empty rows
...
# Move in 立柱
move_model_after('立柱', 'LG-1370-NEO+200H', 'LG-1370')

# Move in 總數
move_model_after('總數', 'LG-1370_NEO+200H', 'LG-1370')
